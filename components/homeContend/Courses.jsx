          ...
          <div className="container mx-auto">
            <div className="flex flex-wrap -mx-4">
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/3 transform hover:-translate-y-1 transition duration-600">
                <div className="mb-10 overflow-hidden duration-300 bg-white rounded-2xl dark:bg-dark-2 shadow-1 hover:shadow-3 dark:shadow-card dark:hover:shadow-3">
                  <img
                    src="/image/valorizacion_residuos.png"
                    alt="image"
                    className="w-full"
                  />
                  <div className="p-8 text-center sm:p-9 md:p-7 xl:p-9">
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/3 transform hover:-translate-y-1 transition duration-600">
                <div className="mb-10 overflow-hidden duration-300 bg-white rounded-2xl dark:bg-dark-2 shadow-1 hover:shadow-3 dark:shadow-card dark:hover:shadow-3">
                  <img
                    src="/image/calidad_alimentaria.png"
                    alt="image"
                    className="w-full"
                  />
                  <div className="p-8 text-center sm:p-9 md:p-7 xl:p-9">
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/3 transform hover:-translate-y-1 transition duration-600">
                <div className="mb-10 overflow-hidden duration-300 bg-white rounded-2xl dark:bg-dark-2 shadow-1 hover:shadow-3 dark:shadow-card dark:hover:shadow-3">
                  <img
                    src="/image/elaboracion_matriz.png"
                    alt="image"
                    className="w-full"
                  />
                  <div className="p-8 text-center sm:p-9 md:p-7 xl:p-9">
              ...
              <div className="w-full px-4 md:w-1/2 xl:w-1/3 transform hover:-translate-y-1 transition duration-600">
                <div className="mb-10 overflow-hidden duration-300 bg-white rounded-2xl dark:bg-dark-2 shadow-1 hover:shadow-3 dark:shadow-card dark:hover:shadow-3">
                  <img
                    src="/image/monitoreo_ocupacionales.png"
                    alt="image"
                    className="w-full"
                  />
                  <div className="p-8 text-center sm:p-9 md:p-7 xl:p-9">
